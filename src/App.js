  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        >
          <Route exact path="/subscrib-page" element={<SubscribPage />}></Route>
          ...
          <Route
            path="/schedule"
            element={<Schedule handleCardClick={handleCardClick} />}
          ></Route>

          <Route
            path="/haifa-2024-schedule"
            element={<ScheduleHaifa handleCardClick={handleCardClick} />}
          ></Route>
          ...
          <Route
            ...
            element={<IndividualPageOfParticipants />}
          />
          ...
          <Route
            ...
            element={<MarketPatisipantsPage addCard={addCard} limit={limit} />}
          />
          ...
          <Route
            ...
            element={<FamilyRelicOnStagePage />}
          ></Route>
          ...
          <Route path="/not-ready-page" element={<NotReadyPage />}></Route>
      ...
      <ImagePopup
        ...
        onClose={closeAllPopups}
      />
      <ContactsPopup onClose={closeAllPopups} isOpen={contactsPopup} />

      <BurgerMainPopup isOpen={isBurgerMainPopup} onClose={closeAllPopups} />

      <OurProjectPopup isOpen={isOurProjectPopup} onClose={closeAllPopups} />
