...
function Presenters() {
    return(
        <section className='presenters__section'>
            <div></div>
            ...
            <ul className='presenters__wrapper'>
                <li className='presenters__li_card'>
                    ...
                    <p>психолог, музейный педагог, куратор образовательных программ Zukunft Memorial — Человек в истории</p>
                </li>
                <li className='presenters__li_card'>
                    <div className='presenters__photo-container'>
                    ...
                    <p>художница, преподаватель,художник-исследователь, педагог, выпускница Аспирантской Школы по искусству и дизайну НИУ ВШЭ</p>
                </li>
                <li className='presenters__li_card'>
                    <div className='presenters__photo-container'>
                ...
                <li className='presenters__li_card'>
                    ...
                    <p>руководитель отдела исследования семейных корней в службе архива Яд Вашем. Автор лекций о использовании ресурсов Яд Вашем для генеалогических и других исследований</p>
                </li>
                <li className='presenters__li_card'>
                    <div className='presenters__photo-container'>
