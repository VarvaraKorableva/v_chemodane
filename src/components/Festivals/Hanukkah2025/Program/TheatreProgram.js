        ...
        <Container as="section">
            ...
            <div className='center_container_hanukkha2025'>
                <ul className='text program_ul'>
                    <li>
                        <h3 className='uppercase'>Детский театр «Зебра» — спектакль «Город клоуна Пика»</h3>
                        <p>
                    ...
                    <li className='TheatreProgram__pics__container'>
                        <h3 className='uppercase'>«Удивительное путешествие Эдварда» (по книге Кейт ДиКамилло)</h3>
                        <p>
                    ...
                    <li>
                        ...
                        <p>
                        Спектакль на иврите от театра Рыба Кива. Спектакль, который одинаково понятен и взрослым,
