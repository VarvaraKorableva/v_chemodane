...
export default function ScienceProgram() {
    return(
        <Container as="section">
            ...
            <Heading className="heading heading__3B6BB4">Научная программа</Heading>

            <div className='center_container_hanukkha2025'>
                <ul className='textprogram_ul'>
                    <li>
                        <h3 className='uppercase'>Биологические мастер-классы от команды «Лаба в музее»</h3>
                        <p>
                    ...
                    <li>
                        <h3 className='uppercase'>Лекции о природе Израиля</h3>
                    ...
                    <li>
                        <h3 className='uppercase'>Интерактивная лекция о молекулах от Якова Журинского</h3>
