          ...
          <div className="aboutFestival__text-container">
            ...
            <div className="aboutFestival__text-wrapper-second">
                <div className="aboutFestival__text">
                    ...
                    <p>Вас ждут спектакли от театров “Алеф”, “Дом черной совы”, “Рыба кива”, “Театрон Самеах” и режиссера Марфы Горвиц. Кинопоказы документальных и художественных фильмов, встречи с писателями и актерами Евгенией Додиной, Линор Горалик, Борисом Лейбовым, Эшколем Нево, Максимом Кронгаузом и многими другими.</p>
                </div>
